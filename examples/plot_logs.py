...
def plot_loss_curves(log_file_path: str):
    ...
    axes[0, 1].plot(df['epoch'], df['train_mse_loss'], label='Train MSE', color='blue', alpha=0.7)
    ...
    # --- Plot 4: Physics Loss ---
    axes[1, 1].plot(df['epoch'], df['train_physics_loss'], label='Train Physics Loss', color='purple', alpha=0.7)
